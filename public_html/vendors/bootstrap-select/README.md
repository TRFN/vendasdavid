...
If you use an older version, you need to add the following either at the bottom of the page (after the last selectpicker), or in a [`LWDKInitFunction.addFN)`](http://api.jquery.com/ready/) block.
```js
